...
export default function ProjectContent({ project }: ProjectContentProps) {
  const projectStats = [
    ...
    },
    {
      ...
      icon: Users,
      color: 'text-green-600 bg-green-50 border-green-200 dark:text-green-400 dark:bg-green-950/30 dark:border-green-800'
    },
    {
      label: '月PV',
    ...
    },
    {
      ...
      icon: Palette,
      color: 'text-cyan-600 bg-cyan-50 border-cyan-200 dark:text-cyan-400 dark:bg-cyan-950/30 dark:border-cyan-800'
    },
    // 第二行
    {
      label: '组件库',
      ...
      icon: Package,
      color: 'text-indigo-600 bg-indigo-50 border-indigo-200 dark:text-indigo-400 dark:bg-indigo-950/30 dark:border-indigo-800'
    },
    {
      label: '数据库',
      value: 'PostgreSQL',
    ...
    // 第三行
    {
      ...
      value: 'Zustand',
      icon: Package,
      color: 'text-teal-600 bg-teal-50 border-teal-200 dark:text-teal-400 dark:bg-teal-950/30 dark:border-teal-800'
    },
    {
      label: '构建工具',
      value: 'Webpack',
      icon: Code,
      color: 'text-sky-600 bg-sky-50 border-sky-200 dark:text-sky-400 dark:bg-sky-950/30 dark:border-sky-800'
    },
    {
      label: '代码规范',
      value: 'ESLint',
      icon: Code,
      color: 'text-pink-600 bg-pink-50 border-pink-200 dark:text-pink-400 dark:bg-pink-950/30 dark:border-pink-800'
    },
    {
      label: '类型检查',
      value: 'TypeScript',
      icon: Code,
      color: 'text-lime-600 bg-lime-50 border-lime-200 dark:text-lime-400 dark:bg-lime-950/30 dark:border-lime-800'
    },
    {
      label: '包管理',
      value: 'npm',
      icon: Package,
      color: 'text-stone-600 bg-stone-50 border-stone-200 dark:text-stone-400 dark:bg-stone-950/30 dark:border-stone-800'
    },
    // 第四行
    {
      label: '监控',
    ...
    },
    {
      ...
      value: 'Storybook',
      icon: Package,
      color: 'text-yellow-600 bg-yellow-50 border-yellow-200 dark:text-yellow-400 dark:bg-yellow-950/30 dark:border-yellow-800'
    },
    {
      label: '协作',
      value: 'GitHub',
      icon: Users,
      color: 'text-gray-600 bg-gray-50 border-gray-200 dark:text-gray-400 dark:bg-gray-950/30 dark:border-gray-800'
    },
    {
      label: '容器化',
      value: 'Docker',
  ...
  const renderTimelineItems = () => {
    ...
    const years = Object.keys(project.timeline).sort((a, b) => parseInt(b) - parseInt(a))
          ...
          {Object.keys(project.timeline![year])
            ...
            .map(month => (
              <div key={`${year}-${month}`} className="space-y-3">
                <h4 className="text-md font-medium text-muted-foreground">{parseInt(month)}月</h4>
                  ...
                  {projectStats.map((stat, index) => {
                    ...
                    return (
                      <div key={index} className="space-y-2">
                        <div className={`inline-flex items-center justify-center w-8 h-8 rounded-lg border ${stat.color}`}>
