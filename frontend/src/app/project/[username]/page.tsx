    ...
    if (activeSection === 'all-projects') {
      ...
      return (
        <div className="space-y-6">
          ...
          {/* 项目网格 */}
          <div className="grid gap-3 sm:gap-4 lg:gap-5" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(380px, 1fr))' }}>
    ...
    if (filteredProjects.length > 0) {
      return (
        <div className="space-y-6">
          ...
          <div className="grid gap-3 sm:gap-4" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(380px, 1fr))' }}>
